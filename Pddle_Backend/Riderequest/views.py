...
from customers.serializers import UserProfileSerializer, RideRequestSerializer
...
def accept_ride_request(request, request_id):
    ...
    ride_request.accepted_by = request.user.driver_profile  # Correct reference to driver profile
